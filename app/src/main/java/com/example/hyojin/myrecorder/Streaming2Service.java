...
public class Streaming2Service extends Thread {
    ...
    public Streaming2Service(int width, int height, int bitrate, int dpi, MediaProjection mp, String dstPath, SrsFlvMuxer mSrsFlvMuxer) {
        super(TAG);
        mWidth = width;
